...
And(/^I see "([^"]*)" in To header$/) do |value|
  ...
  #Assertions_Step: Проверка наименования искомого заголовка группы To
  if actual_value != value
    fail("Expected value is #{value},but actual value was #{actual_value}")
  end
end
...
#Ввод чисел(в том числе многозначных) с помощью виртуальной клавиатуры
And(/^I press "([^"]*)" on soft keyboard$/) do |value|
  ...
  #+Assertions_Step: Проверка соответствия найденного Hectare искомому
